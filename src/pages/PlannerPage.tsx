    ...
    <div className="max-w-6xl mx-auto space-y-10 pb-20">
      ...
      {isLoading ? (
        <div className="h-96 flex flex-col items-center justify-center gap-4">
          ...
          <span className="text-[10px] font-black uppercase tracking-widest text-primary animate-pulse">Running Neural Calculus...</span>
        </div>
      ) : tasks.length === 0 ? (
        <Card className="glass-card border-dashed border-white/10 p-20 text-center space-y-6">
          <div className="w-20 h-20 bg-primary/10 rounded-full flex items-center justify-center mx-auto border border-primary/20">
            <Target className="w-10 h-10 text-primary" />
          </div>
          <div className="space-y-2">
            <h3 className="text-2xl font-black uppercase tracking-tight text-white italic">Roadmap Buffer Empty</h3>
            <p className="text-white/40 text-sm max-w-sm mx-auto">Upload your syllabus in the "Forging Station" to allow the AI to architect your study routine.</p>
          </div>
          <Button onClick={handleGenerateClick} className="bg-primary text-black font-black uppercase tracking-widest px-10 h-14 rounded-2xl shadow-xl shadow-primary/20">
            Initiate Forge
          </Button>
        </Card>
      ) : (
